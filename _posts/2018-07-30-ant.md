---
#layout: post
title: "Using" ant filesets, mapper and paths
date: 2018-07-28
categories: ant
author: EldarEccor
---

Every once in a while I have to fix a legacy build which always means one thing: Welcome back to [ant](https://ant.apache.org/). As I tend to struggle with how ant handles paths, files, filesets, mappers and properties, I decided to share our example :)
